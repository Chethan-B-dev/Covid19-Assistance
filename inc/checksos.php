...
$query="SELECT * FROM `query1` ORDER BY `id` desc;";
...
<div id="size" class="view flex-center">
    ...
    <h1 class="ml1">
        <span class="text-wrapper">
            ...
            <span class="letters">Queries</span>
    ...
    <table id="dtBasicExample" class="table table-hover table-responsive-sm table-borderless text-left rounded" cellspacing="0" width="100%">
...
<?php
  ...
  while($row=mysqli_fetch_array($result)){
    ...
    <tr id="tr" class="font-weight-bold">
      ...
      <td  class="font-weight-bold email"> <?php echo $row["email"]; ?> </td>
      <td class="font-weight-bold"><?php echo $row["phone"]; ?> </td>
      <td class="font-weight-bold" style="word-break:break-word;"> <?php echo $row["location"]; ?> </td>
      <td class="font-weight-bold" style="word-break:break-word;"> <?php echo $row["message"]; ?> </td> 
...
<?php
    ...
    <div class="jumbotron card  brown lighten-2 rounded hoverable">
            <div class="text-black text-center py-5 px-4">
                ...
                <h1 id="text-head" class="h1 pt-1 mb-5 font-bold text-capitalize"><strong>There are no queries to display right now.</strong></h1>
                
                <a href="welcomepersonnel.php" class="btn btn-yellow btn-md btn-rounded font-weight-bold text-dark"><i class="fas fa-undo mr-2"></i>Back to menu</a>
                </div>
            </div>
    </div>
<?php
  ...
  <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
    ...
    <div class="modal-content text-center">
      ...
      <div class="modal-header d-flex justify-content-center font-weight-bold">
        <p class="heading">Do you really want to delete this SOS message?</p>
      </div>
...
<div class="modal fade" id="successmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-sm modal-notify modal-success" role="document">
    ...
    <div class="modal-content text-center">
      <!--Header-->
      <div class="modal-header d-flex justify-content-center font-weight-bold">
        <p class="heading text-capitalize">The SOS Message was successfully deleted</p>
      </div>
...
$('.third-button').on('click', function () {
  ...
  $('.animated-icon3').toggleClass('open');
            ...
            $("#dtBasicExample #tr").click(function somename(){
                $("#deletemodal").modal("show")
                            window.name=$(this).find(".name").text()
                            window.email=$(this).find(".email").text()
                            name=$.trim(name)
                            email=$.trim(email)
                 ...
                 $("#deletequery").on("click",function(){
                    ...
                    $("#successmodal").on("hide.bs.modal",function(){
                        window.location.href="checksos.php";
                    })
            ...
            $(document).ready(function () {
                ...
                $('.dataTables_length').addClass('bs-select');
                        ...
                        if($(window).scrollTop()>20){
                            ...
                            $("#brandanime").removeClass("text-dark").addClass("text-white")
                        }else{
                            $("#brandanime").removeClass("text-white").addClass("text-dark")
