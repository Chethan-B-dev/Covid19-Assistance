...
?>
    ...
    ?>
        ...
        <main>
            ...
            <div id="size" class="view flex-center">
                ...
                <div class="container overflow-auto">
                        ...
                        <div class="row flex-center mb-5">
                            <h3 class="ml1">
                                <span class="text-wrapper">
                                    ...
                                    <span class="letters">Update Patient Info</span>
                    ...
                    if ($count > 0) {
                    ?>
                        <h5 class="pink-text font-weight-bold text-center text-md-left text-capitalize">
                            Click on the patient name to update his/her information.
                        </h5>
                        ...
                        <table id="dtBasicExample" class="table table-hover table-responsive-xs table-borderless text-left rounded table-striped" cellspacing="0" width="100%">
                            <thead class="colornav">
                                <tr>
                                    ...
                                    <th class="th-sm d-none">Condition
                                    </th>
                                    <th class="th-sm d-none">Condition
                                    </th>
                                    <th class="th-sm d-none">Condition
                            ...
                            <tbody class="font-weight-bold grey lighten-5">
                                ...
                                ?>
                                    ...
                                    <tr id="tr" class="font-weight-bold">
                                        ...
                                        <td class="font-weight-bold phone"><?php echo $row["phone"]; ?> </td>
                                        <td class="font-weight-bold loc" style="word-break:break-word;"> <?php echo $row["loc"]; ?> </td>
                                        <td class="font-weight-bold c" style="word-break:break-word;"> <?php echo $row["cond"]; ?> </td>
                                        <td class="font-weight-bold d-none m" style="word-break:break-word; "> <?php echo $row["medicine"]; ?> </td>
                                        <td class="font-weight-bold d-none a" style="word-break:break-word;"> <?php echo $row["allergy"]; ?> </td>
                                        <td class="font-weight-bold d-none e" style="word-break:break-word;"> <?php echo $row["emergency"]; ?> </td>
                                        <td class="font-weight-bold d-none mh" style="word-break:break-word;"> <?php echo $row["mh"]; ?> </td>
                                        <td class="font-weight-bold d-none dob" style="word-break:break-word;"> <?php echo $row["dob"]; ?> </td>
                                        <td class="font-weight-bold d-none blood" style="word-break:break-word;"> <?php echo $row["blood"]; ?> </td>
                        ...
                        <div class="jumbotron card brown lighten-2 rounded hoverable">
                            <div class="text-black text-center py-5 px-4">
                                ...
                                <div>
                                    ...
                                    <h1 id="text-head" class="h1 pt-1 mb-5 font-bold text-capitalize"><strong>There are no Patients to display right now.</strong></h1>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="text-center my-4 py-2">
                                <h5 class="font-weight-bold text-capitalize green-ic">Click on the Information you want to change and edit it</h5>
                            </div>
                            <div class="font-weight-bold mb-3">
                                <span class="dark-grey-text">Name:</span><span> </span><span class="green-text" id="name"></span>
                            ...
                            <div class="font-weight-bold mb-3">
                                <span class="dark-grey-text">Location/Address:</span><span class="green-text" id="loc" style="word-break:break-word"></span>
                            ...
                            <div class="font-weight-bold mb-3">
                                <span class="dark-grey-text">Condition:</span><span> </span><span class="bod green-text" contentEditable="true" id="c"> </span>

                            </div>
                            <div class="font-weight-bold mb-3">
                                <span class="dark-grey-text">Medicine Given:</span><span> </span><span class="bod green-text" contentEditable="true" id="m"></span>

                            </div>
                            <div class="font-weight-bold mb-3">
                                <span class="dark-grey-text">Allergies:</span><span> </span><span class="bod green-text" contentEditable="true" id="a"></span>

                            </div>

                            <div class="font-weight-bold mb-3">
                                <span class="dark-grey-text">Medical History:</span><span> </span><span class="bod green-text" contentEditable="true" id="mh" style="word-break:break-word"></span>
                        ...
                        <div class="modal-footer d-flex d-md-block align-items-center justify-content-center text-right">
                            ...
                            <button id="save" type="button" class="btn btn-success btn-sm">Save Changes</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-sm modal-notify modal-success" role="document">
                    ...
                    <div class="modal-content text-center">
                        ...
                        <div class="modal-header d-flex justify-content-center font-weight-bold">
                            <p class="heading text-capitalize">Patient Information was successfully updated</p>
                        </div>
        ...
        <script>
            ...
            let al = $("#dtBasicExample #tr").find(".a").text()
            let me = $("#dtBasicExample #tr").find(".m").text()
            let co = $("#dtBasicExample #tr").find(".c").text()
            let omh = $("#dtBasicExample #tr").find(".mh").text()
            ...
            $("#save").click(function() {
                ...
                let name = $(this).parent().parent().find(".modal-body").find("#name").text()
                let age = $(this).parent().parent().find(".modal-body").find("#age").text()
                name = $.trim(name)
                age = $.trim(age)



                let ca = $("#modal").find("#a").text()
                let cm = $("#modal").find("#m").text()
                let cc = $("#modal").find("#c").text()
                let cmh = $("#modal").find("#mh").text()
                $.ajax({
                    type: "POST",
